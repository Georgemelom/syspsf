...
function setarAcao(botao){
    document.formCadastrarPaciente.hidAcao.value = botao.id;
}
</script>
...
<table border="0" cellspacing="0" cellpadding="0">
	...
	if (erros != null && !erros.isEmpty()) { 
		...
		<form bgcolor="#bbbcca" id="formCadastrarPaciente"
			name="formCadastrarPaciente" method="post" action="CadastrarPaciente"><input
		...
		<table width="90%" border="0" align="center">
			...
			<tr>
                ...
                %> />
				Masculino <input name="pcSexo" type="radio" tabindex="3" value="2"
		...
		<table width="90%" border="0" align="center">
			...
			<tr>
				...
				<div align="center">
				<p><br />
				<input name="adicionarPaciente" type="submit" id="adicionarPaciente"
					tabindex="24" onclick="setarAcao(this);" value="Adicionar" /> <input

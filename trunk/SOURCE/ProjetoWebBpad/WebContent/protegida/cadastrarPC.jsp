			...
			<TABLE cellSpacing="0" cellPadding="0" width="98%" align="center"
				...
				Iterator i = erros.iterator();</jsp:scriptlet>
						...
						<form bgcolor="#bbbcca" id="formCadastrarPaciente"
							name="formCadastrarPaciente" method="post"
				...
				out.print("checked='checked'");
						...
						<table width="90%" border="0" align="center">
							...
							<tr>
								...
								<div align="center">
								<p><br>
								<input name="adicionarPaciente" type="submit"
									id="adicionarPaciente" tabindex="24" onclick="setarAcao(this);"
									value="Adicionar"> <input name="detalharPaciente"
									type="submit" id="detalharPaciente" tabindex="25"

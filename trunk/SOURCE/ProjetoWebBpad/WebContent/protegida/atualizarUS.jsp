...
<title>Atualizar Unidade de Saude</title>
			...
			<TABLE cellSpacing="0" cellPadding="0" width="98%" align="center"
				...
				<TBODY>
					<TR>
						...
						<form bgcolor="#bbbcca" id="formAtualizarUnidadeSaude"
							name="formAtualizarUnidadeSaude" method="post"
							action="AtualizarUnidadeSaude"><input name="hidAcao"
							type="hidden" value="">

						<table width="90%" border="0" align="center">
							<tr>
								<td colspan="2" class="tituloSecao" color="">Atualizar
								Unidade de Saude</td>
							</tr>
							<tr>
								<br />
							...
							<tr>
								...
								<td><input name="usCnes" type="text" id="usCnes"
									...
									value="${requestScope.unidadesaude.usCnes}"
									style="width: 166px" /></td>
							</tr>
							<%
								UnidadeSaude unidadesaude = (UnidadeSaude) request
										.getAttribute("unidadesaude");
							...
							<tr>
								...
								<td><input name="cidade_ciSigla" type="text"
									...
									value="${unidadesaude.cidade_ciSigla}" style="width: 168px" /></td>
							</tr>
							<tr>
						...
						<table width="90%" border="0" align="center">
							...
							<tr>
								...
								<div align="center">
								<p><br>
								<input name="atualizarUnidadeSaude" type="submit"
									id="atualizarUnidadeSaude" tabindex="24"
									onclick="setarAcao(this);" value="Atualizar"> <input
									name="detalharUnidadeSaude" type="submit"
									id="detalharUnidadeSaude" tabindex="25"

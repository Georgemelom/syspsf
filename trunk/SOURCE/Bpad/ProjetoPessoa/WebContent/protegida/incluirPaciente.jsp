...
<jsp:useBean id="paciente" class="modelo.entidades.Paciente" scope="request">
</jsp:useBean>
...
<table border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
	...
	<%@ include file="subMenu/paciente.jsp" %>	
	</td>
    <td width="50"><img src="mm_spacer.gif" alt="" width="50" height="1" border="0" /></td>
    <td colspan="3" valign="top" style="height: 1773px"><p style="height: 192px"><img src="mm_spacer.gif" alt="" width="305" height="1" border="0" /><br />
</p>
	<%
	...
	<% } %>					
      ...
      <form id="formIncluirPaciente" name="formIncluirPaciente" method="post" action="ServletIncluirPaciente">
	  <input name="hidAcao" type="hidden" value="" />
	  <input name="hidIdPaciente" type="hidden" value="${paciente.idPaciente}" /> 
        <table width="90%" border="0" align="center">
          ...
          <tr>
            ...
            <td><input name="idPaciente" type="text" id="idPaciente" tabindex="1" size="12" 
            	maxlength="12"  value="${paciente.idPaciente}"/></td>
          </tr>
          <tr>
            <td class="tituloCampo">Nome:</td>
            <td><input name="nome" type="text" id="nome" tabindex="1" size="50" 
            	maxlength="100"  value="${paciente.nome} "/></td>
          </tr>
          <tr>
            ...
            if(paciente != null && paciente.getDataNascimento() != null){
            	out.print(formato.format(paciente.getDataNascimento()));
            }%>"/> p.exemplo : (dd/mm/aaaa)
            </td>
          </tr>
          <tr>
            ...
            <td><input name="sexo" type="radio" value="1" tabindex="3" 
                <% 
                if (paciente.getSexo() != null && paciente.getSexo().equals(1)){
                	out.print("checked=\"checked\"");
                }
                %> />
              Masculino
                <input name="sexo" type="radio" tabindex="3" value="2" 
                <% if (paciente.getSexo() != null && paciente.getSexo().equals(2))
                	out.print("checked=\"checked\""); %>/> 
            Feminino </td>
          </tr>
        </table>
...
Residencial - (83) 3232-3232</td>
        ...
        <table width="90%" border="0" align="center">
          ...
          <tr>
            <td><div align="center">
                <p><br />
                  <input name="adicionarPaciente" type="submit" id="adicionarPaciente" tabindex="24" onclick="setarAcao(this);" value="Adicionar Paciente"/>
                  <input name="detalharPaciente" type="submit" id="detalharPaciente" tabindex="25" onclick="setarAcao(this);" value="Detalhar Paciente"/>

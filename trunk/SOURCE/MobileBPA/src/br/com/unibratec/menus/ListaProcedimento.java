...
public class ListaProcedimento extends List implements CommandListener {

	private static ListaProcedimento instance;
	
	private Command cmd_sair;
	private Command cmd_voltar;
	private Command cmd_ok;

	private ListaProcedimento(String title) {
	...
	public static ListaProcedimento getInstance(String title) {
		if (instance == null) {
			instance = new ListaProcedimento(title);
		}
		return instance;
	}

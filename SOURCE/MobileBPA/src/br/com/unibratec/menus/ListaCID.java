...
public class ListaCID extends List implements CommandListener {

	private static ListaCID instance;
	
	private Command cmd_sair;
	private Command cmd_voltar;
	private Command cmd_ok;

	private ListaCID(String title) {
	...
	public static ListaCID getInstance(String title) {
		if (instance == null) {
			instance = new ListaCID(title);
		}
		return instance;
	}

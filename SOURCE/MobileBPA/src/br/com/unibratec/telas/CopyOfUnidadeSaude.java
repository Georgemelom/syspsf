...
public class CopyOfUnidadeSaude extends Form implements CommandListener {
	...
	private static CopyOfUnidadeSaude instance;

	public static CopyOfUnidadeSaude getInstance(String title) {
		if (instance == null) {
			instance = new CopyOfUnidadeSaude(title);
		}
		return instance;
	}

	private CopyOfUnidadeSaude(String title) {
		super(title);

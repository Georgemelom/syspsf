...
<table border="0" cellspacing="0" cellpadding="0">
	...
	if (erros != null && !erros.isEmpty()) { 
		...
		<form bgcolor="#bbbcca" id="formCadastrarProfissional" name="CadastrarProfissional"
			method="post" action="CadastrarProfissional"><input
			name="hidAcao" type="hidden" value="" />

		<table width="90%" border="0" align="center">
			<tr>
				<td colspan="2" class="tituloSecao" color>Dados do Profissional</td>
			</tr>
			<tr>
				<td class="tituloCampo">CNS:</td>
				<td><input name="psCns" type="text" id="psCns" tabindex="1"
					size="12" maxlength="12" value="${profissionalsaude.pcCns}"
					style="width: 166px" /></td>
			</tr>
			<tr>
				<td class="tituloCampo">CBO:</td>
				<td><input name="cbo_Cbo" type="text"
					id="cbo_Cbo" tabindex="2" size="12" maxlength="12"
					value="${profissionalsaude.cbo_Cbo}" style="width: 68px" /></td>
			</tr>
			<tr>
				<td class="tituloCampo">Nr. Conselho:</td>
				<td><input name="conselhos_conselho" type="text" id="conselhos_conselho" tabindex="3"
					size="50" maxlength="100" value="${profissionalsaude.conselhos_conselho} " /></td>
			</tr>
			<tr>
				<td class="tituloCampo">Unidade:</td>
				<td><input name="unidadeSaude_usCnes" type="text" id="unidadeSaude_usCnes" tabindex="4"
					size="6" maxlength="100" value="${profissionalsaude.unidadeSaude_usCnes} " /></td>
			</tr>
			<tr>
		...
		<table width="90%" border="0" align="center">
			...
			<tr>
				...
				<div align="center">
				<p><br />
				<input name="adicionarProfissional" type="submit" id="adicionarProfissional"
					tabindex="24" onclick="setarAcao(this);" value="Adicionar" />
				<input name="detalharProfissional" type="submit" id="detalharProfissional"

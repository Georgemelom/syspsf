...
<table border="0" cellspacing="0" cellpadding="0">
	...
	if (erros != null && !erros.isEmpty()) { 
		...
		<form bgcolor="#bbbcca" id="formCadastrarFichaDiaria" name="CadastrarFichaDiaria"
			method="post" action="CadastrarFichaDiaria"><input
		...
		<table width="90%" border="0" align="center">
			...
			<tr>
				...
				<div align="center">
				<p><br />
				<input name="adicionarFicha" type="submit" id="adicionarFicha"

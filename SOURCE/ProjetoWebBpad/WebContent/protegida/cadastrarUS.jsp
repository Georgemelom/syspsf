...
<table border="0" cellspacing="0" cellpadding="0">
	...
	if (erros != null && !erros.isEmpty()) { 
		...
		<form bgcolor="#bbbcca" id="formCadastrarUnidadeSaude" name="CadastrarUnidadeSaude"
			method="post" action="CadastrarUnidadeSaude"><input
		...
		<table width="90%" border="0" align="center">
			...
			<tr>
				...
				<div align="center">
				<p><br />
				<input name="adicionarUnidade" type="submit" id="adicionarUnidade"
